...
channels = [channel for channel in channels if channel in ["mc23_wph_hyy"]]
...
for channel in channels:
    ...
    df.Snapshot(channel, f"ntuples/{channel}_stxs.root", weights_to_save + list(htxs_categories_to_save.keys()))